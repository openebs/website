...
* **Bold text:** To bold text, add two asterisks or underscores before and after a word or phrase. For example, `**italic text**`, `__italic text__`. Both of these texts will be rendered as **bold text**.
* **Italic text:** To italicize text, add one asterisk or underscore before and after a word or phrase. For example, `*bold text*`, `_bold text_`. Both of these texts will be rendered as *italic text*
