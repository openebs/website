...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    window.innerWidth <= VIEW_PORT.MOBILE_BREAKPOINT
  ...
  return (
    <div>
      <Metadata
        ...
        url={`${currentOrigin}${SeoJson.pages.home.url}`}
        image={`${currentOrigin}${SeoJson.pages.home.image}`}
        isPost={false}
      />
      <section>
        {isMobileView ? (
          <Grid container spacing={0}>
            ...
            <Grid item sm={4} xs={1}>
              <Paper className={[classes.paper, classes.secondGrid].join(' ')}>
                <img
                  loading="lazy"
                  placeholder="../images/png/homepage_main.png?q=20"
                  src="../images/png/homepage_main.png?q=20"
                  alt={t('home.landingScreenImageAlt')}
            ...
            <Grid item xs={12}>
              <Paper className={[classes.paper, classes.tabsWrapper].join(' ')}>
                ...
                >
                  <Tab
                    label={t('home.openebs.label')}
                    {...a11yProps(0)}
                    className={classes.tabButton}
                  />
                  <Tab
                    label={t('home.concepts.label')}
                    {...a11yProps(1)}
                    className={classes.tabButton}
                  />
                  <Tab
                    label={t('home.community.label')}
                    {...a11yProps(2)}
                    className={classes.tabButton}
                  />
                </Tabs>
                <TabPanel value={tabValue} index={0}>
                  ...
                  <Button
                    ...
                    href={EXTERNAL_LINKS.OPENEBS_GET_STARTED}
                    target="_blank"
                  >
                ...
                <TabPanel value={tabValue} index={2}>
                  ...
                  <Button
                    ...
                    endIcon={(
                      <img
                        loading="lazy"
                        src="../images/logos/slack_white.svg"
                        alt={t('home.community.joinOnSlack')}
                      />
                    )}
                    href="/community"
                  >
                  ...
                  <Button
                    ...
                    endIcon={(
                      <img
                        loading="lazy"
                        src="../images/logos/github_orange.svg"
                        alt={t('home.community.joinOnGitHub')}
                      />
                    )}
                    className={classes.outlineButton}
                ...
                <TabPanel value={tabValue} index={0}>
                  <Typography className={classes.tabBodyText}>
                    <Trans i18nKey="home.openebs.description">
                      OpenEBS helps Developers and Platform SREs easily deploy
                      Kubernetes Stateful Workloads that require fast and highly
                      reliable
                      <Link href="/docs/concepts/cas" className={classes.link}>
                        Container attached storage
                      </Link>
                      {' '}
                      OpenEBS turns any storage available on the Kubernetes
                      worker nodes into local or distributed Kubernetes
                      Persistent Volumes.
                    </Trans>
                  </Typography>
                  <Button
            ...
            <Grid item lg={6} md={5} sm={4}>
              <Paper className={classes.paper}>
                <span className={classes.landingImage}>
                  <LazyLoadImage
                    effect="blur"
                    src="../images/png/homepage_main.png"
                    alt={t('home.landingScreenImageAlt')}
                  />
                </span>
              </Paper>
      ...
      <section>
        ...
        <Grid container spacing={3} className={classes.sectionDiv}>
          <Grid item md={4} sm={6}>
            <Paper
              className={[classes.paper, classes.iconTextContainer].join(' ')}
            >
              <div className={classes.iconHolder}>
                <img
                  loading="lazy"
                  src="../images/svg/money_bag.svg"
                  alt={t('home.whatsInItForYou.saveMoney')}
                />
              </div>
              <Typography className={classes.description}>
                <Trans i18nKey="home.whatsInItForYou.saveMoney">
                  <strong>
                    Save money, improve the resilience of your cloud storage
                    {' '}
                  </strong>
                  {' '}
                  – thanks to thin provisioning and the ability to span
                  availability zones and to spin up and down easily in some
                  cases users are saving 30% or more on their cloud storage via
                  the use of container attached storage.
                </Trans>
              </Typography>
            </Paper>
          </Grid>
            ...
            >
              <div className={classes.iconHolder}>
                <img
                  ...
                  alt={t('home.whatsInItForYou.flexibility')}
                />
              </div>
              <Typography className={classes.description}>
                <Trans i18nKey="home.whatsInItForYou.flexibility">
                  <strong>Run anywhere the same way</strong>
                  {' '}
                  – especially with a
                  solution like OpenEBS that is in the user space, you can
                  abstract away from the various flavors of storage; this is
                  consistent with the mission of Kubernetes itself of course!
                </Trans>
              </Typography>
            </Paper>
          </Grid>
          <Grid item md={4} sm={6}>
            ...
            >
              <div className={classes.iconHolder}>
                <img
                  loading="lazy"
                  src="../images/svg/wheel.svg"
                  alt={t('home.whatsInItForYou.resilience')}
                />
              </div>
              <Typography className={classes.description}>
                <Trans i18nKey="home.whatsInItForYou.resilience">
                  <strong>Kubernetes is becoming ubiquitous</strong>
                  {' '}
                  – providing
                  for the first time a means to scale solutions like Container
                  Attached Storage software. OpenEBS with CAS pattern extends
                  the benefits of Kubernetes patterns and benefits to storage.
                </Trans>
              </Typography>
            </Paper>
          </Grid>
            ...
            >
              <div className={classes.iconHolder}>
                <img
                  ...
                  alt={t('home.whatsInItForYou.restoreData')}
                />
              </div>
              <Typography className={classes.description}>
                <Trans i18nKey="home.whatsInItForYou.restoreData">
                  <strong>Cloud-native data protection</strong>
                  {' '}
                  - The backup and
                  restore of OpenEBS volumes works with Kubernetes backup and
                  restore solutions such as Velero. Data backup to object
                  storage targets such as AWS S3, GCP Object Storage, or MinIO
                  are frequently deployed using the OpenEBS.
                </Trans>
              </Typography>
            </Paper>
          </Grid>
            ...
            >
              <div className={classes.iconHolder}>
                <img
                  ...
                  alt={t('home.whatsInItForYou.openSource')}
                />
              </div>
              <Typography className={classes.description}>
                <Trans i18nKey="home.whatsInItForYou.openSource">
                  <strong>Avoid vendor lock-in</strong>
                  {' '}
                  - Using OpenEBS as a
                  data abstraction layer, data can be much more easily moved
                  amongst Kubernetes environments, whether they are on-premise
                  and attached to traditional storage systems or in the cloud.
                </Trans>
              </Typography>
            </Paper>
          </Grid>
            ...
            >
              <div className={classes.iconHolder}>
                <img
                  ...
                  alt={t('home.whatsInItForYou.granularControl')}
                />
              </div>
              <Typography className={classes.description}>
                <Trans i18nKey="home.whatsInItForYou.granularControl">
                  <strong>Applications have changed</strong>
                  {' '}
                  – applications and
                  the teams that build them now have very different
                  requirements; OpenEBS allows for providing volumes to
                  applications with just enough features ranging from local to
      ...
      <section>
        ...
        <Grid
          container
          spacing={3}
          className={events.length ? '' : classes.noEvents}
        >
          <Grid
            item
            xs={12}
            sm={!isMobileView ? 3 : 12}
            xl={3}
          ...
          {events.length ? (
            ...
            <Typography variant="h4" className={classes.noEventText}>
              <Link
                target="_blank"
                className={classes.noEventLink}
                href={EXTERNAL_LINKS.CNCF_EVENTS}
              >
      ...
      <section className={classes.testimonialSection}>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12}>
            <Paper
              className={[classes.paper, classes.testimonialPaper].join(' ')}
            >
              {adopterTestimonials && (
            ...
            <div className={classes.adopterButtonWrapper}>
              <Button
                ...
                className={classes.solidButton}
                onClick={() => {
                  window.open(EXTERNAL_LINKS.BECOME_ADOPTER, '_blank');
                }}
              >
                {t('adoptersTestimonials.becomeAdopter')}
              </Button>
          ...
          <div className={classes.readyToStartSection}>
            ...
            <Grid container spacing={3} alignItems="center">
              <Grid item md={4} sm={12}>
                <Paper
                  className={[classes.paper, classes.flyingMuleWrapper].join(
                    ' ',
                  )}
                >
                  <span
                    className={`${classes.flyingMule} ${classes.imageFluid}`}
                  >
                    <LazyLoadImage
                      effect="blur"
                      src="../images/png/flying_mule.png"
                      alt={t('home.youAreReadyToStart.flyingMuleAlt')}
                    />
                  </span>
                </Paper>
              </Grid>
              <Grid item md={8} sm={12} className={classes.maxWidth}>
                ...
                >
                  <Grid item lg={7} sm={6} xs={12}>
                    <Paper
                      className={[classes.paper, classes.centerContent].join(
                        ' ',
                      )}
                    >
                      <div
                        ...
                        <div className={classes.codeBlock}>
                          ...
                          <LightTooltip title={copyCommand.status}>
                            ...
                            >
                              <img
                                loading="lazy"
                                src="../images/svg/copy_orange.svg"
                                alt=""
                              />
                            </IconButton>
                          </LightTooltip>
                    ...
                    >
                      <div>
                        ...
                        <Typography className={classes.readGuideDescription}>
                          {t(
                            'home.youAreReadyToStart.readTheGuide.description',
                          )}
                        </Typography>
                      </div>
                    </Paper>
