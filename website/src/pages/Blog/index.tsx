...
const Blog: React.FC = () => {
  ...
  return (
    <>
     <Metadata title={SeoJson.pages.blog.title} description={SeoJson.pages.blog.description} url={`${getHostOrigin}${SeoJson.pages.blog.url}`} image={`${getHostOrigin}${SeoJson.pages.blog.image}`} isPost={false} type="Series"  />
      {!queryAuthorName ? (
        <>
