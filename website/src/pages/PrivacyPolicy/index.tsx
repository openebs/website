            ...
            <div className={classes.pageSpacing}>
                    ...
                    {/* <Trans> component in react-i18next allows us to add HTML in our translation texts*/}
                        <Trans i18nKey="privacyPolicy.intro">
                            OpenEBS knows that you care about how your personal information is used and shared, and we take your privacy seriously. Please read the following to learn more about our privacy policy. By visiting {" "} 
                            <a href="/" className={classes.link}> openebs.io </a> {" "}
                            (the "Site"), you acknowledge that you accept the practices and policies outlined in this Privacy Policy. 
                            For the purposes of the EU General Data Protection Regulation 2016 (the "GDPR"), the data controller is MayaData, Inc. 
                            whose registered office is at 4300 Stevens Creek Boulevard, Suite 270, San Jose, CA 95129.
                        </Trans>
                    ...
                    <Typography className={classes.bodyText}>
                        {t('privacyPolicy.informationCollection.infoProvidedByUserDescription')}
                    </Typography>
                    ...
                    <Typography className={classes.bodyText}>
                        {t('privacyPolicy.informationCollection.infoCollectedByUsDescription')}
                    </Typography>
