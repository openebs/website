...
![](/content/images/2020/01/cstor-disk-standard.png)cStor pool with all replicas in healthy state![](/content/images/2020/01/-ci-ssd-pool.png)cStor pool with some volume replicas in unhealthy state‌‌
### 
