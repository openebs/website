...
keywords:
  - OpenEBS use cases
description: OpenEBS is a fully open source storage stack needed for easily and effectively running stateful applications on Kubernetes.
---
...
OpenEBS is a fully open source storage stack needed for easily and effectively running stateful applications on Kubernetes.
