...
Containers and Kubernetes have disrupted the way platforms and technology stacks are built and OpenEBS is a result of applying the patterns of containers and container orchestratation to storage software. The benefits of using OpenEBS are very much inline with what users are observing in the overall technology stack. A few call-outs worth mentioning are:
...
- [High availability - Lower Blast Radius](#high-availability)
