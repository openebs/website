...
<TwoColumn left="1fr" right="200px">
  <p>
    ...
    more details on CAS architecture are found <a href="/docs/next/cas.html">here</a>.
  </p>
...
[OpenEBS Benefits](/docs/introduction/benefits) [Object Storage with OpenEBS](/docs/next/minio.html) [Read Write Many (RWX) PVs with OpenEBS](/docs/next/rwm.html) [Local storage for Prometheus ](/docs/next/prometheus.html)
