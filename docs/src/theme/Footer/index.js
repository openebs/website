...
function ContributorColumn({ title, titleHref, contributors, useFormattedName = false, }) {
    return (<div className={styles.column}>
      ...
      <ul className={styles.columnList}>
        {contributors.map((contributor) => {
            ...
            return (<li key={`${title}-${contributor}`}>
    ...
    return (<footer className={`footer ${styles.footer}`} style={{ backgroundImage: `url(${footerBackgroundSrc})` }}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.linksGrid}>
          ...
          <ContributorColumn contributors={newContributors} title="New contributors" titleHref={NEW_GITHUB_CONTRIBUTORS_URL} useFormattedName/>
        </div>
      </div>
